...
public class MakananAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //deklarasikan View
        img_gambar = convertView.findViewById(
                R.id.img_gambar);
        tvManakanName = convertView.findViewById(
                R.id.tv_makanan_name);
        tvMakananDesc = convertView.findViewById(
                R.id.tv_makanan_description);
